...
from anony.helpers import format_exception, meval, cmd


@app.on_message(cmd(["eval", "exec"]) & filters.user(app.owner))
@app.on_edited_message(cmd(["eval", "exec"]) & filters.user(app.owner))
@lang.language()
